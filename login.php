...
<div class="login-box">
  ...
  <div class="login-box-body" style="text-align: center;">
    <img style="text-align: center;"  src="images/<?php echo $data['foto'] ?>" width="120" height="150" >
    </br></br>
    <a href="" style="color: green; font-size: 25px;"><b>E-SURAT (Elektronik Surat)</a>
    <p class="login-box-msg" style="color:green; font-size: 16px;">PENGADILAN TINGGI AGAMA PALEMBANG</p>
