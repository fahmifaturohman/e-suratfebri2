...
<div class="panel-body">
                                    ...
                                    <form method="POST" enctype="multipart/form-data" onsubmit="return validasi(this)" >
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="foto_lama" value="<?=$file_surat?>">
                                        </div>


                                        <div>
                                        	<input type="submit" name="simpan" value="Update Perubahan" class="btn btn-primary">
                                        </div>
                                 </div>
 ...
 <?php
  ...
  $indek = $_POST['indek'];
    ...
    if($foto != "") {
        if(file_exists("file/masuk/".$file_surat)) {
            unlink("file/masuk/".$file_surat);
        }        
        move_uploaded_file($lokasi, "file/masuk/".$foto);
    }
    else {
 	...
 	if ($simpan) {
        if (!empty($lokasi)) {
 		$sql = $koneksi->query("update  tb_surat_masuk set no_surat='$no', tgl_surat='$tgl_surat', tanggal_terima='$tgl_terima', asal_surat='$asal', sifat_surat='$sifat', perihal='$perihal', no_agenda='$agenda', file_surat='$foto', tujuan='$tujuan', kode_surat='$kode_surat', indeks='$indek' where id='$id'");
