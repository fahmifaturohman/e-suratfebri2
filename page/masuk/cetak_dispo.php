...
<?php 
  ...
  $id = $_GET['id'];
  $sql1 = $koneksi->query("select * from tb_disposisi, tb_surat_masuk, m_dispos, ref_klasifikasi, tb_asal_tujuan where tb_disposisi.teruskan=m_dispos.id_dispos and tb_disposisi.kode_surat=ref_klasifikasi.id and tb_surat_masuk.asal_surat=tb_asal_tujuan.id_asal_tujuan and tb_disposisi.no_agenda='$id'");
...
<table class="tabel" width="100%" border="1">
  <tr>
    <td height="23" colspan="2" valign="top"><strong style="font-size: 16px;"><?php echo $data['lembaga'] ?> </strong><br> <?php echo $data['alamat'] ?></td>
  </tr>
  <tr>
    <td height="46" colspan="2"><div align="center"><strong style="font-size: 16px;">LEMBAR DISPOSISI</strong></div></td>
  </tr>
  <tr>
