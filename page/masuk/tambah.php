                                ...
                                <div class="col-md-6">
                                    ...
                                    <form method="POST" enctype="multipart/form-data" onsubmit="return validasi(this)"  >
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input class="form-control" name="agenda" id="agenda" value="<?php echo $format ?>"  />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="sifat" name="sifat">
                                                   ...
                                                   <option value="sp">Rahasia</option>
                                        ...
                                        <div>
                                        	...
                                        	<input type=button value="Cancel" onclick=self.history.back() class="btn btn-default" />
 ...
 <?php
  if (isset($_POST['simpan'])) {
      ...
      $lokasi = $_FILES['foto']['tmp_name'];
       ...
       $upload = move_uploaded_file($lokasi, "file/masuk/".$foto);
      
      
      if ($upload) {
          $query = "INSERT INTO `tb_surat_masuk` SET 
              `no_surat` = '$no', 
              `tgl_surat` = '$tgl_surat', 
          ...
          echo "
              <script>
                  setTimeout(function() {
                      swal({
                          title: 'Gagal',
                          text: 'Surat Masuk Gagal Disimpan!',
                          type: 'error'
                      }, function() {
                          window.location = '?page=masuk';
                      });
