                        ...
                        <form role="form" method="POST" enctype="multipart/form-data" onsubmit="return validasi(this)">
                         ...
                         <div class="col-md-6">
			                ...
			                <div class="form-group">
                                ...
                                <input class="form-control" name="agenda" id="agenda" value="<?=$format?>" placeholder="contoh : 0831" />
                            </div>
                           ...
                           <div class="col-md-6">  
                            ...
                            <div class="form-group">
                             ...
                             <input type=button value="Cancel" onclick=self.history.back() class="btn btn-secondary" />
...
<?php
	...
	if (isset($_POST['simpan'])) {
      ...
      $tahun = date('Y');
        ...
        $upload = move_uploaded_file($lokasi, "file/keluar/".$foto);



        if ($upload) {

		$simpan = $koneksi->query("insert into tb_surat_keluar (no_surat, tgl_surat, tanggal_keluar, kepada, sifat_surat, perihal, no_agenda, kode_surat, foto, tujuan, tahun)values('$no', '$tgl', '$tanggal_keluar', '$kepada',  '$sifat',  '$perihal', '$agenda', '$kode_surat', '$foto', '$tujuan', '$tahun')");
