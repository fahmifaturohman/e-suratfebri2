<div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-success box-solid">
                        <div class="box-header with-border">
                             Data Surat Keluar 2 Tahun Terakhir
                        </div>
                        ...
                        <a id="lap_masuk" data-toggle="modal" data-target="#lap" style="margin-bottom: 8px; margin-left: 5px;" class="btn btn-default"><i class="fa fa-print"></i> Cetak PDF</a>
                         <input type=button value=Kembali onclick=self.history.back() style="margin-bottom: 8px; margin-left: 5px;"  class="btn btn-info" />
		   ...
		   <td><?php echo date('d-m-Y', strtotime($data['tanggal_keluar'])) ?></td>
                   <td><?php echo $data['asal_tujuan'] ?></td>
                   <td><?php echo $data['sifat_surat'] ?></td>
                   <!-- <td><?php echo $data['perihal'] ?> <br> <a href="page/keluar/file_surat.php?id=<?php echo $data['no_agenda']; ?>" target="_blank"><div style="color: green;"><?=$data['foto']?></a><div></td> -->
                   <td><?php echo $data['perihal'] ?> <br> <a href="<?=$baseUrl?>/file/keluar/<?=$data['foto']?>" target="_blank"><div style="color: green;"><?=$data['foto']?></a><div></td>     
                   <td>


                      <a  href="?page=keluar&aksi=ubah&id=<?php echo $data['id_surat'];?>" class="btn btn-info"> <i class="fa fa-edit"></i> Ubah</a>
                      <a onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data ini...???')" href="?page=keluar&aksi=hapus&id=<?php echo $data['id_surat'];?>"" class="btn btn-danger"> <i class="fa fa-trash"></i> Hapus</a>
