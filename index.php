...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b style="font-size:14px;">E-SURAT (Elektronik Surat)</b></span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2024 Pengadilan Tinggi Agama Palembang</a>.</strong> All rights
    reserved.
  </footer>
